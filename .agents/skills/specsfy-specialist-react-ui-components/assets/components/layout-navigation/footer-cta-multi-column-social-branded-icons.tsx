        ...
        <div className="mt-24 border-t border-gray-900/10 pt-12 xl:grid xl:grid-cols-3 xl:gap-8 dark:border-white/10">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm/6 font-semibold text-gray-950 dark:text-white">Soluções</h3>
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm/6 font-semibold text-gray-950 dark:text-white">Suporte</h3>
                <ul role="list" className="mt-6 space-y-4">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm/6 font-semibold text-gray-950 dark:text-white">Empresa</h3>
                <ul role="list" className="mt-6 space-y-4">
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm/6 font-semibold text-gray-950 dark:text-white">Jurídico</h3>
                <ul role="list" className="mt-6 space-y-4">
