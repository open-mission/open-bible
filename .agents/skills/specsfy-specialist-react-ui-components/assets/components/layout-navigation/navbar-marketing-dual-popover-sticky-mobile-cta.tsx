...
const products = [
  ...
  { name: 'Integrações', description: 'Conecte ferramentas de terceiros', href: '#', icon: SquaresPlusIcon },
  { name: 'Automações', description: 'Crie funis estratégicos para aumentar as conversões', href: '#', icon: ArrowPathIcon },
]
...
const company = [
  { name: 'Sobre nós', href: '#', description: 'Saiba mais sobre os valores e a missão da nossa empresa' },
  { name: 'Carreiras', href: '#', description: 'Procurando sua próxima oportunidade? Veja todas as vagas abertas' },
  {
    name: 'Suporte',
    href: '#',
    description: 'Fale com nossa equipe de suporte ou participe dos fóruns da comunidade',
  },
  { name: 'Blog', href: '#', description: 'Leia os anúncios mais recentes e conheça a visão da nossa equipe' },
]
